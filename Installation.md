...
Substitute your openSUSE version in the command below (in this case we are considering openSUSE Leap 15.5):

```bash
$ sudo zypper ar https://download.opensuse.org/repositories/devel:/tools:/scm/15.5/devel:tools:scm.repo
```
